                    ...
                    <div class="border-bottom mb-4">
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div>
                                ...
                                <span class="text-black fs-16"><a class="text-decoration-none dark-red" href="mailto:info@bhandaripackersandmovers.in">info@bhandaripackersandmovers.in</a></span>
                            </div>
                        </div>
                    </div>
                    <div class="border-bottom mb-4">
