		...
		<form name="form1" id="form1" method="post" action="" autocomplete="off">
			...
			<div class="col-sm-10">
				<select name="category" class="form-control" ng-model="x.category" required>
					...
					<option value='3'>Car Shifting</option>
					<option value='4'>Bike Shifting</option>
					<option value='5'>IBA Packers</option>
				</select>
			</div>
			<div class="clearfix"></div>
			<div class="col-sm-2 ">
			...
			<div class="col-sm-10">
				<input name="url" class="form-control" ng-model="x.url" required>
			</div>
			<div class="clearfix"></div>
			<div class="col-sm-2 ">
			...
			<div class="col-sm-10">
				<textarea class="form-control" name="description" ng-model="x.description"></textarea>
			</div>
			...
			<div class="col-sm-10">
				...
				<summernote config="options" ng-model="x.blogDetails"></summernote>
				<textarea name="blogDetails" ng-model="x.blogDetails" hidden></textarea>
			</div>
			...
			<div class="col-sm-3" ng-show="x.image">
				<img src="<?= base_url("assets/uploads/blog/thumb") ?>/{{x.image}}" class="img-responsive"
					style="height: 150px;">
			</div>
			...
			<div class="col-sm-12">
				<div id="webprogress" style="display: none">
					<img src="<?= base_url() ?>/assets/admin/images/loading.gif">
				</div>
