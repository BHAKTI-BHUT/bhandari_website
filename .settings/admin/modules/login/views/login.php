...
<head>
    ...
    <title>Bhandari Packers and Movers <?=date("D d M Y")?></title>
    
    <link href="<?=base_url()?>assets/admin/css/main.css" rel="stylesheet">
    <link rel="icon" type="image/png" href="<?=base_url()?>assets/images/logo/logo.jpg"/>
</head>
...
<br><br><br><br>            
    <div class=" col-sm-4 col-sm-offset-4 text-center">
        ...
        <br>
        <img src="<?=base_url("assets/images/logo/logo.jpg")?>" class="img-show" style="width:150px;" alt="logo">
        <br><br><br>
