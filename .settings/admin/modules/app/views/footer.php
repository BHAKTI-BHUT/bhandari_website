    ...
    <?php if ($this->session->userdata('username')):?>
    	...
    	<script src="<?=base_url("assets/admin/datepicker/bootstrap-datetimepicker.min.js")?>"></script>		<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>    	<script src="<?=site_url('app/app_main')?>"></script>
